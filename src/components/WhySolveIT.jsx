...
const WhySolveIT = () => {
  ...
  return (
    <div className="container">
      <h1 className="primaryColor Heading3 mb-16">Why DevSync</h1>
        ...
        {cards.map((card) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6 z-10">
              ...
              >
                <h1 className="Heading1 primaryColor mb-2">
                  {card.number}
                </h1>
                <h2 className="Text3 primaryColor">{card.title}</h2>
              </div>

              {/* Points */}
              <ul
                className={`absolute bottom-0 left-0 w-full p-6 space-y-2 text_four Text3 transition-all duration-700 ease-in-out 
                ${
                  activeCard === card.id
