...
const Spinner = () => {
  ...
  return (
    <div
      ...
      backdrop-blur-md bg-transparent z-50 transition-opacity duration-700
      ${fadeOut ? "opacity-0 pointer-events-none" : "opacity-100"}`}
      style={{
        backgroundColor: "rgba(255, 255, 255, 0)", // pure transparent
      }}
    >
      <div className="relative flex justify-center items-center">
        ...
        <svg
          aria-hidden="true"
          className="w-20 h-20 text-gray-300 animate-spin fill-blue-600 drop-shadow-lg"
          viewBox="0 0 100 101"
          fill="none"
        ...
        {/* Percentage */}
        <span className="absolute text-white text-xl font-semibold drop-shadow-md">
          {progress}%
        </span>
      </div>
    </div>
